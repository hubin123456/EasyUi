	...
	<div class="easyui-tabs" style="width: 100%; height: 600px;">
		<div title="入库管理" style="padding-top: 20px; display: none;">
			<table id="searchTable" align="left" fit="true">
				<tr>
					<td width="110px" align="right">入库单编号:</td>
					<td><select id="rukudanid" style="width: 100px; height: 21px;"
						data-options="valueField:'caozuoId',textField:'caozuoId',url:'jinghuoselect.do'"
						class="easyui-combobox" editable="false">
					</select></td>
					<td width="90px" align="right">入库用户:</td>
					...
					<td width="90px" align="right">入库仓库:</td>
					<td><select id="rukudandate1"
						style="width: 100px; height: 21px;"
			...
			<table id="luku" class="easyui-datagrid" style="height: 430px;">
				<thead style="background: #273045; color: #ffffff;">
					<tr>
						<th align="center" width="100" field="caozuoId">入库单编号</th>
						...
						<th align="center" name="username" field="username" width="100">入库用户</th>
