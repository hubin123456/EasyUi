...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/highcarts/highcharts.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/jquery-easyui-1.4.1/jquery.easyui.min.js"></script>
</head>
<body>
	<div id="tt" class="easyui-tabs" style="width: 1100px; height: 600px;">
		<div title="仓库货物分布情况" style="padding: 30px; display: none;">
			<%@ include file="baobiao/huowufenbutu.jsp"%>
		</div>
	</div>
