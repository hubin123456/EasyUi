...
public class MD5 {
     ...
     * @return
     */
    public  static String getMD5String1(String s) {
     ...
     * @return
     */
    public  boolean checkPassword(String md5, String md5PwdStr) {
    	boolean flag=false;
        if( md5.equals(md5PwdStr)){
        	flag=true;
        }
        return flag;
    }
...
//        File file = new File("e:/games/dota2.zip");
//        String md5 = getFileMD5String(file);
//        
//        //文件名不同，内容相同；
//        File file2 = new File("D:/ftp/dota2.zip");
//        String md52= getFileMD5String(file2);
//        
//        
        //文件名不同，内容不同；
    	MD5 md5=new MD5();
    	System.out.println(md5.getMD5String1("123456"));
      /*  File file3 = new File("e:/12345(3).txt");
        String md53= md5.getFileMD5String(file3);*/
//        
//      
//        //测试压缩包
...
//        
//        //测试压缩包
//        File fileZip2 = new File("e:/IMBS_883000_20151022_ADD.tar.Z");
...
//    	MD5 md5=new MD5();
//    	md5.getFileMD5String(new File("d://123.txt"));
